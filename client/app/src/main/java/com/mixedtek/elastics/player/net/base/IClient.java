package com.mixedtek.elastics.player.net.base;
...
public abstract class IClient {
    ...
    public boolean startClient(final String ip, final int port, final int sndBufferSize, final int rcvBufferSize, final int timeout) {
        try {
