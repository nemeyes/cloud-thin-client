...
public class Preferences {
    ...
    private static final String NAME = "com.mixedtek.elastics.player";
    ...
    private static final String KEY_ONDEMAND_CONNECTION = "ondemand_connection";
    ...
    public static void setOnDemandConnection(boolean value) {
        putBoolean(KEY_ONDEMAND_CONNECTION, value);
    }
    ...
    public static boolean getOnDemandConnection() {
        return getBoolean(KEY_ONDEMAND_CONNECTION, false);
    }
