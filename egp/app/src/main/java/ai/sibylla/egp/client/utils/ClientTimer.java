...
public class ClientTimer extends TimerManager {
    ...
    public static void startControlContainerOpenTimer(OnTimeoutListener listener) {
        startTimer(CONTROL_CONTAINER_OPEN, ClientContext.CONTROL_CONTAINER_OPEN, listener);
    }
    ...
    public static void startControlKeepAliveTimer(OnTimeoutListener listener) {
        startTimer(CONTROL_KEEP_ALIVE, ClientContext.CONTROL_KEEP_ALIVE_TIME, listener);
    }
    ...
    public static void startControlKeepAliveResponseTimer(OnTimeoutListener listener) {
        startTimer(CONTROL_KEEP_ALIVE_RESPONSE, ClientContext.CONTROL_KEEP_ALIVE_RESPONSE_TIME, listener);
    }
    ...
    public static void startControlGyroTimer(OnTimeoutListener listener) {
        startTimer(CONTROL_GYRO, ClientContext.CONTROL_KEEP_CONTROL_GYRO_TIME, listener);
    }
