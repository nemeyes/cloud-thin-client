package com.mixedtek.elastics.controller.view;
...
import com.mixedtek.elastics.controller.R;


public class GameControllerView extends View implements Runnable {
    ...
    */
    ...
    public GameControllerView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs);
    }
    ...
    public GameControllerView(Context context, AttributeSet attrs) {
        ...
        TypedArray styledAttributes = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.GameControllerView,
                0, 0
        );
        ...
        try {
            buttonColor = styledAttributes.getColor(R.styleable.GameControllerView_GCV_buttonColor, DEFAULT_COLOR_BUTTON);
            borderColor = styledAttributes.getColor(R.styleable.GameControllerView_GCV_borderColor, DEFAULT_COLOR_BORDER);
            mBorderAlpha = styledAttributes.getInt(R.styleable.GameControllerView_GCV_borderAlpha, DEFAULT_ALPHA_BORDER);
            backgroundColor = styledAttributes.getColor(R.styleable.GameControllerView_GCV_backgroundColor, DEFAULT_BACKGROUND_COLOR);
            borderWidth = styledAttributes.getDimensionPixelSize(R.styleable.GameControllerView_GCV_borderWidth, DEFAULT_WIDTH_BORDER);
            mFixedCenter = styledAttributes.getBoolean(R.styleable.GameControllerView_GCV_fixedCenter, DEFAULT_FIXED_CENTER);
            mAutoReCenterButton = styledAttributes.getBoolean(R.styleable.GameControllerView_GCV_autoReCenterButton, DEFAULT_AUTO_RECENTER_BUTTON);
            mButtonStickToBorder = styledAttributes.getBoolean(R.styleable.GameControllerView_GCV_buttonStickToBorder, DEFAULT_BUTTON_STICK_TO_BORDER);
            buttonDrawable = styledAttributes.getDrawable(R.styleable.GameControllerView_GCV_buttonImage);
            mEnabled = styledAttributes.getBoolean(R.styleable.GameControllerView_GCV_enabled, true);
            mButtonSizeRatio = styledAttributes.getFraction(R.styleable.GameControllerView_GCV_buttonSizeRatio, 1, 1, 0.25f);
            mBackgroundSizeRatio = styledAttributes.getFraction(R.styleable.GameControllerView_GCV_backgroundSizeRatio, 1, 1, 0.75f);
            mButtonDirection = styledAttributes.getInteger(R.styleable.GameControllerView_GCV_buttonDirection, BUTTON_DIRECTION_BOTH);
        } finally {
